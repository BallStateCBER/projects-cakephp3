...
return [
     ...
     */
     'Email' => [
         'default' => [
             'transport' => 'Debug',
             'from' => ['projects@cberdata.org' => 'Ball State CBER'],
             'sender' => ['projects@cberdata.org' => 'Ball State CBER'],
             'returnPath' => 'projects@cberdata.org',
             'emailFormat' => 'both'
         ]
     ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'database' => env('DB_DATABASE') ?: 'okbvtfr_projectstesting',
            'encoding' => 'utf8mb4',
        ...
        'test' => [
            ...
            'username' => 'root',
            'password' => env('DB_PASSWORD') ?: null,
            'database' => 'okbvtfr_projectstesting',
            'encoding' => 'utf8mb4',
            'cacheMetadata' => true,
            'quoteIdentifiers' => false,
            'log' => false,
    ...
    'data_center_subsite_url' => 'http://projects.cberdata.org',
    'data_center_subsite_title' => 'Projects and Publications',
    'google_analytics_id' => 'UA-32998887-5'
];
