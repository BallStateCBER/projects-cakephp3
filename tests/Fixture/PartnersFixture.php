...
class PartnersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'short_name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2018-01-30 16:29:02',
            'modified' => '2018-01-30 16:29:02'
        ],
    ];
}
